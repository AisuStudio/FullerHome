...
export default function AboutContentEn({ locale }: { locale: Locale }) {
  return (
    <>
      ...
      <h2>Datasheet</h2>
      <p>
        All values react live to the house type and budget configured on the{" "}
        <Link href={withLocale(locale, "/")}>simulation page</Link> — change the
        configuration there and the datasheet recalculates.
      </p>
